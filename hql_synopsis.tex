...
Human brokers are replaced by computer systems, and traders are now joined by\ab{last sentence makes no sense by itself. Next paragraph is something \emph{completely} different}  
colocated machines that perform high-frequency trading using predefined and backtested algorithms\ab{Removed the part about backtesting, but this was a use-case...}.\\
...
\ab{Again, this shouldn't be included, this is the learning goals/problem statement}.
\begin{itemize}
...
others relying on stochastic simulation. In this project, we will mainly work with closed-form functions for bonds and
