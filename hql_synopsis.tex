...
\ab{Need more here before technical stuff?}

%\cite{composingcontracts} presents a Haskell combinator library for describing a
%financial contracts to further emphasize the .\\
